...
# Copy message bus
scp ~/Documents/projects/pinkyandbrain/claude-messenger.js "$TARGET:~/pinkyandbrain/"

# Copy CLI tool
if [ -f ~/Documents/projects/pinkyandbrain/pinky-cli.sh ]; then
    scp ~/Documents/projects/pinkyandbrain/pinky-cli.sh "$TARGET:~/pinkyandbrain/"
...
if [ -f ~/Documents/projects/pinkyandbrain/run-on-all.sh ]; then
    if ! grep -q '"brain"' ~/Documents/projects/pinkyandbrain/run-on-all.sh; then
        sed -i '' 's/MACHINES=(\([^)]*\))/MACHINES=(\1 "brain")/' ~/Documents/projects/pinkyandbrain/run-on-all.sh
        log "Added brain to run-on-all.sh"
    fi
fi

# Add brain to audio bridge
if [ -f ~/Documents/projects/pinkyandbrain/audio-bridge.js ]; then
    if ! grep -q "brain" ~/Documents/projects/pinkyandbrain/audio-bridge.js; then
...
echo "     cd ~/Documents/projects/pinkyandbrain"
